...
public class Diu_VC extends Project_variables {
    
    float bonus=0;
    float fined=0;
   
    Diu_VC(String name,String id,String cell_number,String email,String address,float work_hours,float period,int salary,int age,int leave, int pat_mat_leave, int withdraw)
    {
        ...
        void salary()
    {
        ...
        void withdraw()
    {
        if (withdraw<=salary)  // period is in months
