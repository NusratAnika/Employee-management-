...
public class Diu_Professor extends Project_variables {
    
    float bonus=0;
    float fined=0;
   
    Diu_Professor(String name,String id,String cell_number,String email,String address,float work_hours,float period,int salary,int age,int leave, int pat_mat_leave, int withdraw)
    {
